...
class Kural3WarmupServiceTest {
 ...
 private static LaplaceVolumeProfileService.WarmupResult result(){return new LaplaceVolumeProfileService.WarmupResult(LocalDate.of(2026,7,30),78,12,false,true,5);}
