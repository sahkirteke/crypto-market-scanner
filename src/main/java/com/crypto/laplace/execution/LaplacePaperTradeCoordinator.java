...
private final AtomicBoolean paperDisabledLogged=new AtomicBoolean(false);
 ...
 private void logDecision(LaplaceSignalResult s,PositionSide effective,LaplaceEntryDecision d,String decision,boolean consumed){log.info("LAPLACE_ENTRY_DECISION symbol={} rawSignal={} effectiveExecutionSide={} signalCandleCloseTime={} atrPercentage={} previousRawTakerImbalance={} currentNormalizedSlope={} previousNormalizedSlope={} currentSlopeStrength={} previousSlopeStrength={} riskyEntry={} strongConfirmedSignal={} entryAllowed={} skipReasons={} decision={} blockedRawDirection={} entryStateConsumed={}",s.symbol(),s.entrySignal(),effective,s.signalCandleCloseTime(),s.atrPercentage(),s.previousRawTakerImbalance(),s.currentNormalizedSlope(),s.previousNormalizedSlope(),Math.abs(s.currentNormalizedSlope()),Math.abs(s.previousNormalizedSlope()),d.riskyEntry(),d.strongConfirmedSignal(),d.entryAllowed(),d.skipReasons(),decision,consumed?s.entrySignal():null,consumed);}
