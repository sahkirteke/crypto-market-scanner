...
public class LaplacePaperTradeCoordinator {
 ...
 public void clearSessionRuntime(){locks.clear();rawStates.clear();strongExitCandles.clear();paperDisabledLogged.set(false);}
