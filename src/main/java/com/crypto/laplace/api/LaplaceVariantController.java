...
public class LaplaceVariantController {
 private final LaplaceVariantApiService api;private final LaplaceRuntimeService trueRuntime;private final LaplaceProfitLockService profitLock;
 ...
 @PostMapping("/inverted-true/session/manual-close")public LaplaceRuntimeStatusResponse closeTrueSession(){profitLock.closeCurrentSession();return trueRuntime.status();}
}
