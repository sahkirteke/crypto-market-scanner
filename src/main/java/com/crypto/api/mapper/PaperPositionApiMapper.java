...
public class PaperPositionApiMapper {
    ...
    public PaperPositionResponse toResponse(PaperPositionEntity entity) {
        ...
        return new PaperPositionResponse(
                ...
                entity.getSymbol(),
                entity.getSide(),
                entity.getSourceSignalSide() == null ? entity.getSide() : entity.getSourceSignalSide(),
                entity.getExecutionSide() == null ? entity.getSide() : entity.getExecutionSide(),
                Boolean.TRUE.equals(entity.getSignalInverted()),
                entity.getInversionReason(),
                entity.getStatus(),
                ...
                entity.getEntryBbScore(),
                entity.getEntryBbPercentB(),
                entity.getEntryBbWidth(),
                entity.getEntryBbUpper(),
                entity.getEntryBbMiddle(),
                entity.getEntryBbLower(),
                entity.getEntryBbUpperTouched(),
                entity.getEntryBbLowerTouched(),
                entity.getEntryBbUpperClosedOutside(),
                entity.getEntryBbLowerClosedOutside(),
                jsonTextMapper.toStringList(entity.getEntryBbReasonsJson()),
                entity.getLongScore(),
